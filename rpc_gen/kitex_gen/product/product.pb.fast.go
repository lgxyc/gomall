...
func (x *ListProductsResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	...
	x.ProductList = append(x.ProductList, &v)
	return offset, nil
}
...
func (x *Product) fastWriteField6(buf []byte) (offset int) {
	if len(x.CategoryList) == 0 {
		return offset
	}
	for i := range x.GetCategoryList() {
		offset += fastpb.WriteString(buf[offset:], 6, x.GetCategoryList()[i])
	}
	return offset
}
...
func (x *ListProductsResp) fastWriteField1(buf []byte) (offset int) {
	...
	for i := range x.GetProductList() {
		offset += fastpb.WriteMessage(buf[offset:], 1, x.GetProductList()[i])
	}
	return offset
}
...
func (x *Product) sizeField6() (n int) {
	...
	for i := range x.GetCategoryList() {
		n += fastpb.SizeString(6, x.GetCategoryList()[i])
	}
	return n
}
...
func (x *ListProductsResp) sizeField1() (n int) {
	...
	for i := range x.GetProductList() {
		n += fastpb.SizeMessage(1, x.GetProductList()[i])
	}
	return n
}
