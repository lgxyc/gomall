...
import (
	_ "github.com/lgxyc/gomall/app/frontend/hertz_gen/api"
...
type SearchProductListReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Query uint32 `protobuf:"varint,1,opt,name=query,proto3" json:"query,omitempty" query:"query"`
}

func (x *SearchProductListReq) Reset() {
	*x = SearchProductListReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *SearchProductListReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchProductListReq) ProtoMessage() {}

func (x *SearchProductListReq) ProtoReflect() protoreflect.Message {
	mi := &file_product_page_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchProductListReq.ProtoReflect.Descriptor instead.
func (*SearchProductListReq) Descriptor() ([]byte, []int) {
	return file_product_page_proto_rawDescGZIP(), []int{1}
}

func (x *SearchProductListReq) GetQuery() uint32 {
	if x != nil {
		return x.Query
	}
	return 0
...
var file_product_page_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_product_page_proto_goTypes = []interface{}{
	...
	(*SearchProductListReq)(nil), // 1: frontend.product.SearchProductListReq
...
var file_product_page_proto_depIdxs = []int32{
	...
	1, // 1: frontend.product.ProductService.SearchProductList:input_type -> frontend.product.SearchProductListReq
	2, // 2: frontend.product.ProductService.GetProduct:output_type -> frontend.common.Empty
	2, // 3: frontend.product.ProductService.SearchProductList:output_type -> frontend.common.Empty
...
func file_product_page_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_product_page_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SearchProductListReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
