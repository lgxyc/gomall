module github.com/lgxyc/gomall/app/cart

go 1.23.4

replace ( // 如果远端代码没有,在本地查找
	github.com/apache/thrift => github.com/apache/thrift v0.13.0
	github.com/lgxyc/gomall/rpc_gen => ../../rpc_gen
)
...
require (
	...
	github.com/lgxyc/gomall/rpc_gen v0.0.0-00010101000000-000000000000
